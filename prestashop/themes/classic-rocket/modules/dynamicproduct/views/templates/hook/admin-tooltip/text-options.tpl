...
<form method="post" class="dp_ajax_form">
	...
	<input type="hidden" name="action" value="save_text_settings">
	<table class="table table-condensed table-striped">
		<tbody>
			...
			<tr>
				<td class="fixed-width-md center"><span class="title_box">{l s='Initial value' mod='dynamicproduct'}</span></td>
				<td class="center">
					<div class="dp_group dp_input_lang">
						<div class="dp_lang_container">
							{foreach from=$dp_languages item=lang}
							<div class="dp_lang">
								<input type="text" value="{if isset($field->value[$lang.id_lang])}{$field->value[$lang.id_lang]|escape:'htmlall':'UTF-8'}{/if}"  name="options[value][{$lang.id_lang|intval}]" class="dp_lang_input dp_no_ajax form-control">
			...
			<tr>
				<td class="fixed-width-md center"><span class="title_box">{l s='Min Characters' mod='dynamicproduct'}</span></td>
				<td class="center"><input class="dp_input_min form-control" data-name="min" name="options[min]" data-type="int" value="{$field->settings->min|floatval}" type="text"/></td>
			</tr>
			<tr>
				<td class="fixed-width-md center"><span class="title_box">{l s='Max Characters' mod='dynamicproduct'}</span></td>
				<td class="center"><input class="dp_input_max form-control" data-name="max" name="options[max]" data-type="int" value="{$field->settings->max|floatval}" type="text"/></td>
			</tr>
			<tr>
