...
<section class="contact-form">
    <form class="js-customer-form needs-validation"
          action="{$urls.pages.contact}" method="post"
        ...
        {if !$notifications || $notifications.nw_error}
            <section class="form-fields">
                ...
                {if $contact.orders}
                    <div class="form-group">
                        <label for="id_order">{l s='Order reference' d='Shop.Forms.Labels'}
                            <small class="text-muted">
                                ({l s='Optional' d='Shop.Forms.Labels'})</small>
                        </label>
                ...
                {if $contact.allow_file_upload}
                    <div class="form-group">
                        <label for="fileUpload">{l s='Attachment' d='Shop.Forms.Labels'}
                            <small class="text-muted">
                                ({l s='Optional' d='Shop.Forms.Labels'})</small>
                        </label>
                        <div class="custom-file">
                            ...
                            <label class="custom-file-label"
                                   for="fileUpload"><span
                                        class="sr-only">{l s='Choose file' d='Shop.Theme.Actions'}</span></label>
                        </div>
                    </div>
                {literal}
                    <style>
