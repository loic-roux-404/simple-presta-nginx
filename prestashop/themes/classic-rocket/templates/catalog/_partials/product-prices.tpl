...
{if $product.show_price && $customer.is_logged}
    <div class="product-prices pr-5">
        {block name='product_discount'}
            ...
            {/if}
        {/block}
        <div class="full-price text-right mb-3">
            {block name='product_price'}
                <div class="product-price d-inline-block {if $product.has_discount}has-discount{/if}">
            ...
            <div class="tax-shipping-delivery-label d-inline-block current-price-display">
        ...
        {block name='product_without_taxes'}
            {*        {if $priceDisplay == 1}*}
            <p class="product-without-taxes current-price-display text-right">

                &nbsp;{l s='%price% tax excl.' d='Shop.Theme.Catalog' sprintf=['%price%' => {$product.price_tax_exc|replace:".":","}]}
            </p>
            {*      {/if}*}
        {/block}
